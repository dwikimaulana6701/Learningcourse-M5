        ...
        <form action="">
            <div className='flex flex-col gap-4'>
                <div id='username'>
                    ...
                    <input type="text" id="name" name="name" className="border border-grayBorder rounded-x w-full text-black h-12 px-3 mt-1"/>
                </div>
                <div id='email'>
                ...
                <div id='gender' className='md:hidden'>
                    ...
                    <div className="relative w-full">
                        <select name="jenkel" id="jenkel" className="relative border border-grayBorder rounded-x w-full font-dmsans font-normal text-sm tracking-extra-tight text-black h-12 px-x py-3 mt-1 appearance-none">
                ...
                <div id='phone'>
                    ...
                    <div className="flex gap-3 w-full md:gap-6">
                        ...
                        <input type="text" id="phone" name="phone" className="w-full border border-grayBorder rounded-lg h-12 px-3 mt-1 text-black focus:outline-none"/>
                    </div>
                </div>
                <div id='password'>
            ...
            <button type="button" onClick={handleRegisterClick} className="bg-[#3ECF4C] hover:bg-green-600 cursor-pointer font-bold text-sm text-white rounded-x tracking-extra-tight py-[7px] px-[22px] mb-4 mt-6 w-full mx-auto flex justify-center lg:text-base">Daftar</button>
            <div className="text-center cursor-pointer bg-grin hover:bg-green-100 rounded-x w-full mx-auto flex justify-center">
                <Link to="/" className="font-bold text-sm tracking-extra-tight py-[7px] px-[22px] text-[#3ECF4C] lg:text-base">Masuk</Link>
            </div>
        </form>
    )
}
